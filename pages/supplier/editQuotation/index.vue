	...
	<view class="grace-body">
		<form @submit="formSubmit" class="grace-form grace-margin-top">
			<view class="grace-items">
				<view class="grace-label">选择商品</view>
				<view class="other">
					<picker @change="bindPickerChange" :range="model" name="model">
			...
			<view class="grace-items">
				...
				<input type="text" class="input" value="7500" name="price" placeholder="请输入含税价" />
			</view>
			<view class="grace-items">
			...
			<view class="grace-items">
				...
				<view class="other">
					<input type="text" class="input" name="endDate" :disabled="true" :value="date2" @tap="showDate2" placeholder="请选择" />
				</view>
			</view>
			...
			<view class="grace-items">
				...
				<input type="text" class="input" value="35" name="num" placeholder="请输入数量" />
			</view>
			<view class="grace-items">
				<view class="grace-label">提货地址</view>
				<input type="text" class="input" value="思明" name="address" placeholder="请输入提货地址" />
			</view>
			<view class="grace-items">
				<view class="grace-label">运费(元/吨)</view>
				<input type="text" class="input" value="10" name="freight" placeholder="请输入运费" />
			</view>
			<view class="grace-items">
				<view class="grace-label">附加费(元/吨)</view>
				<input type="text" class="input" value="0.00" name="surcharge" placeholder="请输入附加费" />
			</view>
			<view class="grace-items">
