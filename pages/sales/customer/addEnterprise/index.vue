	...
	<view class="">
		<view class="grace-body">
			<form @submit="formSubmit" class="grace-form grace-margin-top">
				...
				<view class="grace-items">
					<view class="grace-label">机构代码</view>
					<input type="text" class="input" placeholder="请输入机构代码" name="enterprise_code" />
				</view>
				<view class="grace-items">
					...
					<view class="grace-label-x">
						<checkbox-group name="category">
							<label class="radio" v-for="(item,index) in category" :key="index">
								<checkbox style="transform:scale(0.8)" :value="item.id+''" color="#FF5722"></checkbox>{{item.name}}
							</label>
						</checkbox-group>
					</view>
				</view>
				<view class="grace-items grace-noborder">
					<view class="clien other">
						<textarea placeholder="请输入企业介绍..." name="v.intro"></textarea>
					</view>
				</view>
	...
	export default {
		...
		methods: {
			...
			formSubmit: function(e) {
				...
				formData["v.area"] = _self.cityText1.split("-").join(","); //此处以保存用户城市代码为例
				formData["v.type"] = "企业"
...
<style>
	...
	.grace-form uni-radio-group,
	.grace-form uni-checkbox-group {
