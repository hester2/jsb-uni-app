		...
		<view class="ot-Dtailes-host">
			<view class="grace-list hj">
				...
				<view class="grace-space-between">
					...
					<view class="demo7  grace-no-scale">厦门市发发集团,15425462365</view>
				</view>
				<view class="grace-space-between">
				...
				<view class="grace-space-between">
					...
					<view class="demo7  grace-no-scale">0.00/10.00</view>
				</view>
				<view class="grace-space-between">
				...
				<view class="grace-space-between">
					...
					<view class="demo7  grace-no-scale">配送</view>
				</view>
				<view class="grace-space-between">
					<view class="demo6">收货地址:</view>
					<view class="demo7  grace-no-scale">思明区</view>
				</view>
			</view>
		</view>
