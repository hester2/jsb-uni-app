		...
		<view class="ot-profile-fp">
			...
			<view class="ot-profile-an fp">
				...
				<view class="grace-body">
					<view class="grace-grids demoForIcon grace-margin-top">
						<view class="items">
							<navigator url="../main/console/index">
								<view class="icon">
						...
						<view class="items">
							<navigator url="../order/salesList/index">
								<view class="icon">
						...
						<view class="items">
							<navigator url="../order/moneyList/index">
								<view class="icon">
						...
						<view class="items">
							<navigator url="../record/recordList/index">
								<view class="icon">
									<image :src="img+'geren8.png'"></image>
								</view>
								<view class="text">来款记录</view>
							</navigator>
						</view>
					</view>
				</view>
